...
function Tips () {
    return(
      ...
      <Accordion.Item eventKey="0">
        <Accordion.Header><h2>The rules of makeup removal.</h2></Accordion.Header>
        <Accordion.Body>
            ...
            <div className="row">
              <div className="row col-12">
                ...
                <span className="tips-text">
                  <p>
                    Skin care is based on removing makeup: sometimes it is enough to adjust the cleansing process to achieve a noticeable improvement in relief, color, 
                  ...
                  <p>The first and most important thing. Who needs a makeup removal?</p>
                  <p>Almost everyone. Yes, even for those who do not use decorative cosmetics at all. Check yourself: if you can sign at least one statement from this list, then a demotion is necessary:</p>
                  <ul className="tips-text">
                    <li>I have oily or combination skin.</li>
                    <li>I leave the house during the day.</li>
                    <li>I sweat a lot.</li>
                    <li>In the morning, I apply facial care.</li>
                    <li>I do makeup regularly.</li>
                  </ul>
                  <p>It seems that the makeup removal is only about make-up. In fact, its purpose is to remove everything from the skin of the face except the natural one.</p>
                  <p>Why is this necessary?</p>
                  <ul>
                    <li>Firstly, everything that we apply to the skin (cream, tone) is guaranteed to oxidize, forming free radicals (the main cause of aging).</li>
                    <li>Secondly, sebum from the sebaceous glands cannot freely reach the surface of the skin if all the passages are closed (one of the causes of inflammation).</li>
                    <li>
                      And finally, poorly cleansed skin does not perceive the care products applied on top (one of the reasons for dullness). 
                  ...
                  <p>Cleansing the skin is not only an evening procedure. It is also necessary in the morning, especially if you use active products at night, and wake up the next morning with a shine in the T-zone.</p>
                  <p>How not to make a demo: 5 common mistakes:</p>
                  <ol className="tips-text">
                    <li>
                      <h4>1. Soap and other alkaline products.</h4>
                      <p>
                ...
                <span className="tips-text">
                  <p>How can I wash off my makeup?</p>
                  <p>
                  ...
                  <p>Such a system is called two-stage purification and looks like this:</p>
                  <ul className="tips-text">
                    <li>•	after waking up, washing with a foaming agent;</li>
                    <li>•	before going to bed — make-up with a greasy remedy and washing with foaming.</li>
                  </ul>
                  <p>At the first stage, the contamination must be dissolved, at the second — washed off.</p>
                  <p>If you complete the process at the first stage (for example, just wipe your face with milk or micellar water), the surfactants themselves and all those particles that we tried to remove will remain on the skin. Consequences: inflammation, bumps, uneven skin tone.</p>
                </span>
                <img src={removeend} alt="removeend" className="tips-img float-start imgshadow" />
                <span className="tips-text">
                  <p>How to find your own pair of funds for makeup removal?</p>
                  <h4>Stage 1: means for makeup removal.</h4>
                  <p>Format: thick cream, balm, micellar water, milk, oil, hydrophilic oil.</p>
                  <p>What it does: according to the principle of "like to like", it collects excess fatty particles from the face (from sebum to decorative cosmetics).</p>
                  <p>Application feature: dry hands on dry skin.</p>
                  <p>What to pay attention to: soft fatty foods additionally soothe dry and sensitive skin, such products are also good in cold weather, when it literally hurts to touch the skin.</p>
                  <h4>Stage 2: face cleanser.</h4>
                  <p>Format: foam, gel, cream cleanser.</p>
                  <p>What does: It washes off the characteristic film left over from the first product and keeps the skin's own lipid barrier intact.</p>
                  <p>Application feature: wet hands on wet skin.</p>
                  <p>
                  ...
                  <h4>Three sites that we sometimes forget about during the makeup removal</h4>
                  <h5>Eyebrows.</h5>
                  <p>During makeup, many people apply three or four products to their eyebrows in stages, but do not pay attention to this area when cleansing the skin. This is fraught with painful inflammation.</p>
                  <h5>Lips.</h5>
                  <p>Even if it seems that there is no trace of morning lipstick, the pores on the skin around the lips are clogged, and the sebum in them oxidizes and darkens.</p>
                  <h5>Hair Growth Line.</h5>
                  <p>Make-up, like make-up, is most effective to do with collected hair, so as not to miss anything for sure. For example, the root zone, where the tone is usually also applied.</p>
                  <h4>How to wash off makeup if I have…</h4>
                  <h5>...contact lenses</h5>
                  <p>The ideal option is to remove the lenses and perform a two—stage cleansing. If this is not possible, the product for makeup removal (balm, milk, oil) instead of the skin, you will have to apply it on a cotton pad so that the application can be controlled.</p>
                  <h5>...extended eyelashes</h5>
                  <p>Greasy products dissolve the glue on which the eyelashes are held, so such products are not suitable for eye makeup. The way out is either extremely careful application with a strong indentation from the area around the eyes, or micellar water.</p>
                  <h5>...acne in the active phase</h5>
                  <p>Open inflammations cannot be rubbed with a disc, so everything soft, greasy, thick and creamy that needs to be applied directly to the skin will work as well as possible: from hydrophilic oil to thick balm.</p>
                  <p>And a few more questions</p>
                  <h4>Is it possible to wash off cosmetics from the face and eyes with the same product?</h4>
                  <p>Of course, if it's comfortable. They do produce separate products for the eyes, but they are needed only for those who are not satisfied with the result of makeup removal a universal product (for example, it does not wash off mascara well or leaves a greasy film).</p>
                  <p>It seems to me that my remedy does not work well — it does not wash off anything the first time.</p>
                  <p>It happens that way. For some reason, many people think that if the tool did not work in 5 seconds, then it does not work at all. In fact, most products need at least 20 seconds to break the bonds between the molecules. And if we are talking about waterproof cosmetics or a lot of makeup, then two or three washes in a row may be required.</p>
                  <h4>Do you have to wash your face at all? They say the anhydrous method is better for the skin.</h4>
                  <p>
      ...
      <Accordion.Item eventKey="1">
        <Accordion.Header><h2>What to pay attention to before taking photos and videos?</h2></Accordion.Header>
        <Accordion.Body>
        <div className="container">
            <div className="row">
              <div className="row col-12">
                ...
                <ul className="tips-text">
                  <li>
                    <h4>1. Do I need a makeup artist service?</h4>
                    <p>
                    ...
                    <p>It is advisable for men not to get a haircut on the day of shooting.</p>
                    <p>
                  ...
                  <li>
                    <h4>2. What can be improved with retouching?</h4>
                    <p>
                  ...
                  <li>
                    <h4>3. Which clothes should be preferred when creating a business portrait?</h4>
                    <p>Choose a classic suit if you adhere to a conservative style or casual — to create a modern dynamic image.</p>
                    <p>It is better to bring clothes with you — on the way to the studio or office, things may get wrinkled or dirty.</p>
                    <p>Don't forget the accessories — tie, cufflinks, watch. It is better to choose jewelry that is not too large and inconspicuous.</p>
                    <p>
      ...
      <Accordion.Item eventKey="2">
        <Accordion.Header><h2>Tips for brides.</h2></Accordion.Header>
        <Accordion.Body>
        <div className="container">
            <div className="row">
              <div className="row col-12">
                ...
                <ul className="tips-text">
                  <li>
                    <h4>1. Should I have a rehearsal or not?</h4>
                    <p>
                  ...
                  <li>
                    <h4>3. Go to a cosmetologist if necessary.</h4>
                    <p>
                  ...
                  <li>
                    <h4>4. Do not abuse the solarium.</h4>
                    <p>
                  ...
                  <li>
                    <h4>5. I advise you to buy:</h4>
                    <ul>
                      <li>matting wipes to periodically refresh your face and the groom's on the wedding day (so that the skin does not shine in the photo);</li>
                      <li>beautiful transparent or colored lip gloss to fix your makeup during the day;</li>
                      <li>loose powder and a brush.</li>
                    </ul>  
                  </li>
                  <li>
                    <h4>6. No experiments.</h4>
                    <p>Do not experiment with exotic remedies on the eve of the wedding, to minimize stress to your skin. Also, try not to drink too much liquid and do not eat spicy and fatty foods.</p>
                  </li>
                  <li>
                    <h4>7. Get enough sleep! </h4>
                    <p>
                  ...
                  <li>
                    <h4>8. Be sure to wash your hair at night and dry it. </h4>
                    <p>It is better not to apply oils to damp hair. The hairstyle lasts much longer on dry hair.</p>
                  </li>
                  <li>
                    <h4>9. Calm atmosphere. </h4>
                    <p>It is desirable that the bride's preparation takes place in a calm atmosphere, so try to make sure that only you, the makeup artist or the stylist are in the room 
                ...
                <p>Use these tips to be and feel irresistible on your wedding day. May this day be remembered as one of the happiest!</p>
              </div>
            </div>
          </div>
        </Accordion.Body>
